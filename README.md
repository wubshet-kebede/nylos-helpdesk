...
The API runs at [http://localhost:5231](http://localhost:5231).

Swagger/OpenAPI documentation is available at [http://localhost:5231/swagger](http://localhost:5231/swagger).
